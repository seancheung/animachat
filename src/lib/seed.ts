...
export function seedPresets() {
  ...
  const tavern = saveLocation({
    ...
    stageStyle: { enabled: true, stageBg: "#1b1410", panelBg: "#2e2013", panelOpacity: 0.5 },
  });
  ...
  saveLocation({
    ...
    stageStyle: { enabled: true, stageBg: "#0e1a12", panelBg: "#142619", panelOpacity: 0.5, messageBg: "#1d3325", messageFg: "#dcedde", panelFg: "#c4dcc9", accent: "#7cc98a" },
  });
